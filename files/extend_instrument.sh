...
ALTER TABLE tess_t ADD COLUMN model        TEXT    DEFAULT 'TESS-W';
ALTER TABLE tess_t ADD COLUMN firmware     TEXT    DEFAULT '1.0';
ALTER TABLE tess_t ADD COLUMN channel      INTEGER DEFAULT  0;
ALTER TABLE tess_t ADD COLUMN cover_offset REAL    DEFAULT  0.0;
ALTER TABLE tess_t ADD COLUMN fov          REAL    DEFAULT  17.0;
